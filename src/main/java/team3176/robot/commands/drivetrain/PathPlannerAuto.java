...
import team3176.robot.commands.superstructure.intakecube.IntakeExtendFreeSpin;
...
public class PathPlannerAuto {
    ...
    public PathPlannerAuto(String autoPathName, Command doBefore) {
        ...
        List<PathPlannerTrajectory> pathGroup = PathPlanner.loadPathGroup(autoPathName, new PathConstraints(1.0, 1.5));  //2.0, 1.5
